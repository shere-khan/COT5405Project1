...
class TestProblem2(unittest.TestCase):
    ...
    def test_schedule_reassign_og(self):
        avgs = []
        ranges = []
        for i in range(100):
            jobs = schedule.ScheduleTool.get_random_jobs(50)
            ...
            # print()
        average = sum(avgs) / len(avgs)
        print("The average of averages for test 5: {}".format(average))
        avg_range = sum(ranges) / len(ranges)
        print("The average range for test 5: {}".format(avg_range))
        print()
